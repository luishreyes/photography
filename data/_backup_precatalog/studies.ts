...
const CONTAINMENT_ORDER = [
  ...
  'Estratos', 'The Pause', 'Plomada', 'Orbit', 'Desembocadura', 'Fuelle', 'Enclosure',
];
...
const rawStudies: Study[] = [
  {
    slug: 'villeta', title: 'Villeta', names: { en: 'Villeta', es: 'Villeta' }, year: 2026, status: 'finished',
    description: {
  ...
  {
    slug: 'dosel', title: 'Dosel', names: { en: 'Canopy', es: 'Dosel' }, status: 'ongoing',
    description: {
  ...
  {
    slug: 'containment', title: 'Containment', names: { en: 'Containment', es: 'Contención' }, status: 'ongoing',
    description: {
  ...
  {
    slug: 'between', title: 'Between', names: { en: 'Between', es: 'Umbral' }, status: 'ongoing',
    description: {
  ...
  {
    slug: 'passenger', title: 'Passenger', names: { en: 'Passenger', es: 'Pasajero' }, status: 'ongoing',
    description: {
  ...
  {
    slug: 'remnant', title: 'Remnant', names: { en: 'Remnant', es: 'Vestigio' }, status: 'ongoing',
    description: {
  ...
  {
    slug: 'ground', title: 'Ground', names: { en: 'Ground', es: 'Suelo' }, status: 'ongoing',
    description: {
  ...
  {
    slug: 'chicago', title: 'Chicago', names: { en: 'Chicago', es: 'Chicago' }, status: 'ongoing',
    description: {
